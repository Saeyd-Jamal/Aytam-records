							...
							<div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label>اقل تاريخ ميلاد لليتيم</label>
                                            <form action="{{route('records-recordsConstants-create')}}" method="POST">
                                                @csrf
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary" type="submit">
                                                        <span class="input-group-btn"><i class="fe fe-check"></i></span></button>
                                                    </span>
                                            </form>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-1">الجنس</label>
                                            ...
                                            <form action="{{route('records-recordsConstants-destroy')}}" method="POST">
                                                @csrf
                                                @method('delete')
                                            ...
                                            <form action="{{route('records-recordsConstants-create')}}" method="POST">
                                                ...
                                                <span class="input-group-btn"><button class="btn btn-primary" type="submit"><span class="input-group-btn"><i class="fe fe-check"></i></span></button></span>
                                            </form>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">المحافظات</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">المدن</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">أماكن الميلاد</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">صلة القرابة لليتيم</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">الحالة الصحية لليتيم</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">هل الطفل يتيم الأبوين؟</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">وضع المنزل</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">هل اليتيم نازح؟</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">استفاد كسوة</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 d-flex justify-content-between align-items-center mb-0">
                                            <label class="col-md-2">استفاد كفالة</label>
